...
Parrot Protocol は、Solana 上に構築された DeFi ネットワークで、ステーブルコインの PAI と、資産を保管しないレンディングマーケット、そして証拠金取引の vAMM から構成されています。 これらはいずれも、DeFi システムにロックされた資産価値へのアクセスを可能にするという一つの問題を解決するために設計されたユースケースです。
...
- PAI を通貨単位とした証拠金取引商品（バーチャル AMM または vAMM）の作成。 これによって、Parrot コミュニティは手数料を徴収し、Parrot ファミリーの食い扶持を稼げるようになります。
